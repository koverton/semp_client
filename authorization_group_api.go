...
type AuthorizationGroupApi struct {
	Configuration *Configuration
}

func NewAuthorizationGroupApi() *AuthorizationGroupApi {
...
func NewAuthorizationGroupApiWithBasePath(basePath string) *AuthorizationGroupApi {
	configuration := NewConfiguration()
 ...
 */
func (a AuthorizationGroupApi) CreateMsgVpnAuthorizationGroup(msgVpnName string, body MsgVpnAuthorizationGroup, select_ []string) (*MsgVpnAuthorizationGroupResponse, *APIResponse, error) {
 ...
 */
func (a AuthorizationGroupApi) DeleteMsgVpnAuthorizationGroup(msgVpnName string, authorizationGroupName string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnAuthorizationGroupResponse
 */
func (a AuthorizationGroupApi) GetMsgVpnAuthorizationGroup(msgVpnName string, authorizationGroupName string, select_ []string) (*MsgVpnAuthorizationGroupResponse, *APIResponse, error) {
 ...
 */
func (a AuthorizationGroupApi) GetMsgVpnAuthorizationGroups(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnAuthorizationGroupsResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnAuthorizationGroupResponse
 */
func (a AuthorizationGroupApi) ReplaceMsgVpnAuthorizationGroup(msgVpnName string, authorizationGroupName string, body MsgVpnAuthorizationGroup, select_ []string) (*MsgVpnAuthorizationGroupResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnAuthorizationGroupResponse
 */
func (a AuthorizationGroupApi) UpdateMsgVpnAuthorizationGroup(msgVpnName string, authorizationGroupName string, body MsgVpnAuthorizationGroup, select_ []string) (*MsgVpnAuthorizationGroupResponse, *APIResponse, error) {
