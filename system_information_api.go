...
type SystemInformationApi struct {
	Configuration *Configuration
}

func NewSystemInformationApi() *SystemInformationApi {
	configuration := NewConfiguration()
	return &SystemInformationApi{
		Configuration: configuration,
	}
}

func NewSystemInformationApiWithBasePath(basePath string) *SystemInformationApi {
	configuration := NewConfiguration()
 ...
 */
func (a SystemInformationApi) GetSystemInformation() (*SystemInformationResponse, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/systemInformation"
	...
	var successPayload = new(SystemInformationResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GetSystemInformation", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
