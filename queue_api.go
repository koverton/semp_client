...
func NewQueueApiWithBasePath(basePath string) *QueueApi {
	configuration := NewConfiguration()
 ...
 */
func (a QueueApi) CreateMsgVpnQueue(msgVpnName string, body MsgVpnQueue, select_ []string) (*MsgVpnQueueResponse, *APIResponse, error) {
 ...
 */
func (a QueueApi) CreateMsgVpnQueueSubscription(msgVpnName string, queueName string, body MsgVpnQueueSubscription, select_ []string) (*MsgVpnQueueSubscriptionResponse, *APIResponse, error) {
 ...
 */
func (a QueueApi) DeleteMsgVpnQueue(msgVpnName string, queueName string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *SempMetaOnlyResponse
 */
func (a QueueApi) DeleteMsgVpnQueueSubscription(msgVpnName string, queueName string, subscriptionTopic string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnQueueResponse
 */
func (a QueueApi) GetMsgVpnQueue(msgVpnName string, queueName string, select_ []string) (*MsgVpnQueueResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnQueueSubscriptionResponse
 */
func (a QueueApi) GetMsgVpnQueueSubscription(msgVpnName string, queueName string, subscriptionTopic string, select_ []string) (*MsgVpnQueueSubscriptionResponse, *APIResponse, error) {
 ...
 */
func (a QueueApi) GetMsgVpnQueueSubscriptions(msgVpnName string, queueName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnQueueSubscriptionsResponse, *APIResponse, error) {
 ...
 */
func (a QueueApi) GetMsgVpnQueues(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnQueuesResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnQueueResponse
 */
func (a QueueApi) ReplaceMsgVpnQueue(msgVpnName string, queueName string, body MsgVpnQueue, select_ []string) (*MsgVpnQueueResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnQueueResponse
 */
func (a QueueApi) UpdateMsgVpnQueue(msgVpnName string, queueName string, body MsgVpnQueue, select_ []string) (*MsgVpnQueueResponse, *APIResponse, error) {
