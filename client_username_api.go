...
type ClientUsernameApi struct {
	Configuration *Configuration
}

func NewClientUsernameApi() *ClientUsernameApi {
...
func NewClientUsernameApiWithBasePath(basePath string) *ClientUsernameApi {
	configuration := NewConfiguration()
 ...
 */
func (a ClientUsernameApi) CreateMsgVpnClientUsername(msgVpnName string, body MsgVpnClientUsername, select_ []string) (*MsgVpnClientUsernameResponse, *APIResponse, error) {
 ...
 */
func (a ClientUsernameApi) DeleteMsgVpnClientUsername(msgVpnName string, clientUsername string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnClientUsernameResponse
 */
func (a ClientUsernameApi) GetMsgVpnClientUsername(msgVpnName string, clientUsername string, select_ []string) (*MsgVpnClientUsernameResponse, *APIResponse, error) {
 ...
 */
func (a ClientUsernameApi) GetMsgVpnClientUsernames(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnClientUsernamesResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnClientUsernameResponse
 */
func (a ClientUsernameApi) ReplaceMsgVpnClientUsername(msgVpnName string, clientUsername string, body MsgVpnClientUsername, select_ []string) (*MsgVpnClientUsernameResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnClientUsernameResponse
 */
func (a ClientUsernameApi) UpdateMsgVpnClientUsername(msgVpnName string, clientUsername string, body MsgVpnClientUsername, select_ []string) (*MsgVpnClientUsernameResponse, *APIResponse, error) {
