...
type MqttSessionApi struct {
	Configuration *Configuration
}

func NewMqttSessionApi() *MqttSessionApi {
	configuration := NewConfiguration()
	return &MqttSessionApi{
		Configuration: configuration,
	}
}

func NewMqttSessionApiWithBasePath(basePath string) *MqttSessionApi {
	configuration := NewConfiguration()
 ...
 */
func (a MqttSessionApi) CreateMsgVpnMqttSession(msgVpnName string, body MsgVpnMqttSession, select_ []string) (*MsgVpnMqttSessionResponse, *APIResponse, error) {
 ...
 */
func (a MqttSessionApi) CreateMsgVpnMqttSessionSubscription(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSessionSubscription, select_ []string) (*MsgVpnMqttSessionSubscriptionResponse, *APIResponse, error) {
 ...
 */
func (a MqttSessionApi) DeleteMsgVpnMqttSession(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *SempMetaOnlyResponse
 */
func (a MqttSessionApi) DeleteMsgVpnMqttSessionSubscription(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionResponse
 */
func (a MqttSessionApi) GetMsgVpnMqttSession(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, select_ []string) (*MsgVpnMqttSessionResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionSubscriptionResponse
 */
func (a MqttSessionApi) GetMsgVpnMqttSessionSubscription(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string, select_ []string) (*MsgVpnMqttSessionSubscriptionResponse, *APIResponse, error) {
 ...
 */
func (a MqttSessionApi) GetMsgVpnMqttSessionSubscriptions(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, count int32, cursor string, where []string, select_ []string) (*MsgVpnMqttSessionSubscriptionsResponse, *APIResponse, error) {
 ...
 */
func (a MqttSessionApi) GetMsgVpnMqttSessions(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnMqttSessionsResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionResponse
 */
func (a MqttSessionApi) ReplaceMsgVpnMqttSession(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSession, select_ []string) (*MsgVpnMqttSessionResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionSubscriptionResponse
 */
func (a MqttSessionApi) ReplaceMsgVpnMqttSessionSubscription(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string, body MsgVpnMqttSessionSubscription, select_ []string) (*MsgVpnMqttSessionSubscriptionResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionResponse
 */
func (a MqttSessionApi) UpdateMsgVpnMqttSession(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, body MsgVpnMqttSession, select_ []string) (*MsgVpnMqttSessionResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnMqttSessionSubscriptionResponse
 */
func (a MqttSessionApi) UpdateMsgVpnMqttSessionSubscription(msgVpnName string, mqttSessionClientId string, mqttSessionVirtualRouter string, subscriptionTopic string, body MsgVpnMqttSessionSubscription, select_ []string) (*MsgVpnMqttSessionSubscriptionResponse, *APIResponse, error) {
