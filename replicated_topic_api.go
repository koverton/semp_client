...
type ReplicatedTopicApi struct {
	Configuration *Configuration
}

func NewReplicatedTopicApi() *ReplicatedTopicApi {
	configuration := NewConfiguration()
	return &ReplicatedTopicApi{
		Configuration: configuration,
	}
}

func NewReplicatedTopicApiWithBasePath(basePath string) *ReplicatedTopicApi {
	configuration := NewConfiguration()
 ...
 */
func (a ReplicatedTopicApi) CreateMsgVpnReplicatedTopic(msgVpnName string, body MsgVpnReplicatedTopic, select_ []string) (*MsgVpnReplicatedTopicResponse, *APIResponse, error) {
 ...
 */
func (a ReplicatedTopicApi) DeleteMsgVpnReplicatedTopic(msgVpnName string, replicatedTopic string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnReplicatedTopicResponse
 */
func (a ReplicatedTopicApi) GetMsgVpnReplicatedTopic(msgVpnName string, replicatedTopic string, select_ []string) (*MsgVpnReplicatedTopicResponse, *APIResponse, error) {
 ...
 */
func (a ReplicatedTopicApi) GetMsgVpnReplicatedTopics(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnReplicatedTopicsResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnReplicatedTopicResponse
 */
func (a ReplicatedTopicApi) ReplaceMsgVpnReplicatedTopic(msgVpnName string, replicatedTopic string, body MsgVpnReplicatedTopic, select_ []string) (*MsgVpnReplicatedTopicResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnReplicatedTopicResponse
 */
func (a ReplicatedTopicApi) UpdateMsgVpnReplicatedTopic(msgVpnName string, replicatedTopic string, body MsgVpnReplicatedTopic, select_ []string) (*MsgVpnReplicatedTopicResponse, *APIResponse, error) {
