...
type TopicEndpointApi struct {
	Configuration *Configuration
}

func NewTopicEndpointApi() *TopicEndpointApi {
	configuration := NewConfiguration()
	return &TopicEndpointApi{
		Configuration: configuration,
	}
}

func NewTopicEndpointApiWithBasePath(basePath string) *TopicEndpointApi {
	configuration := NewConfiguration()
 ...
 */
func (a TopicEndpointApi) CreateMsgVpnTopicEndpoint(msgVpnName string, body MsgVpnTopicEndpoint, select_ []string) (*MsgVpnTopicEndpointResponse, *APIResponse, error) {
 ...
 */
func (a TopicEndpointApi) DeleteMsgVpnTopicEndpoint(msgVpnName string, topicEndpointName string) (*SempMetaOnlyResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnTopicEndpointResponse
 */
func (a TopicEndpointApi) GetMsgVpnTopicEndpoint(msgVpnName string, topicEndpointName string, select_ []string) (*MsgVpnTopicEndpointResponse, *APIResponse, error) {
 ...
 */
func (a TopicEndpointApi) GetMsgVpnTopicEndpoints(msgVpnName string, count int32, cursor string, where []string, select_ []string) (*MsgVpnTopicEndpointsResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnTopicEndpointResponse
 */
func (a TopicEndpointApi) ReplaceMsgVpnTopicEndpoint(msgVpnName string, topicEndpointName string, body MsgVpnTopicEndpoint, select_ []string) (*MsgVpnTopicEndpointResponse, *APIResponse, error) {
 ...
 * @return *MsgVpnTopicEndpointResponse
 */
func (a TopicEndpointApi) UpdateMsgVpnTopicEndpoint(msgVpnName string, topicEndpointName string, body MsgVpnTopicEndpoint, select_ []string) (*MsgVpnTopicEndpointResponse, *APIResponse, error) {
