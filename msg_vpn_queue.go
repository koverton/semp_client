...
type MsgVpnQueue struct {
	...
	// The maximum number of simultaneous Consumers of the Queue. The default value is `1000`.
	...
	// The maximum message size (in bytes) allowed in the Queue. The default value is `10000000`.
	MaxMsgSize int32 `json:"maxMsgSize,omitempty"`

	// The maximum spool usage (in MB) of the Queue. Setting the value to zero enables the last-value-queue feature and disables quota checking. The default varies by platform. The default varies by platform.
